...
const StyledCardHeader: React.FC<{
  ...
  return (
    <Wrapper isFinished={isFinished} background={background} style={{background:'transparent'}}>
      <Flex alignItems="center" justifyContent="space-between">
        ...
        {isAutoVault ? (
          ...
          // <TokenImage primaryToken={earningToken} secondaryToken={stakingToken} width={64} height={64} />
